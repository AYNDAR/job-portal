...
import { EmployerJob, EmployerApplication } from "./types";
...
export const fetchJobApplications = createAsyncThunk(
  ...
  async (jobId: string) => {
    ...
    return { jobId, applications: res.data as EmployerApplication[] };
  },
);
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchJobApplications.fulfilled, (state, action) => {
        // store applications keyed by jobId? For simplicity, just overwrite.
